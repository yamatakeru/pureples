...
CONFIG = neat.config.Config(CppnGenome, neat.reproduction.DefaultReproduction,
                            ...
                            'pureples/experiments/xor/config_cppn_genome_xor')
...
def run(gens, version):
    ...
    print(f"es_hyperneat_with_cppn_genome_xor_{VERSION_TEXT} done")
    return winner, stats
...
if __name__ == '__main__':
    ...
    WINNER_NET = NETWORK.create_phenotype_network(
        filename=f'pureples/experiments/xor/es_hyperneat_with_cppn_genome_xor_{VERSION_TEXT}_winner.png')
    ...
    draw_net(
        CPPN, filename=f"pureples/experiments/xor/es_hyperneat_with_cppn_genome_xor_{VERSION_TEXT}_cppn")
    with open(f'pureples/experiments/xor/es_hyperneat_with_cppn_genome_xor_{VERSION_TEXT}_cppn.pkl', 'wb') as output:
